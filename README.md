...
The `commits_by_lesson` branch contains the completed application. Each commit in this branch corresponds with the state of the application at the end at of each lesson, and is labeled as such.
